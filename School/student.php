...
<div>
    ...
    <div class = "container text-center mt-5">
        <div class = "row">
            <div class = "col">
                <h2 class = "text-dark">AUST STUDENT DATABASE</h2>
                <a href = "existingstudent.php" class = "btn btn-outline-warning">Existing Student</a>
                <a href = "newstudent.php" class = "btn btn-outline-warning">New Student</a>
            </div>
        </div>
    </div>
</div>
