...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="noticeadmin.php">Notice Board</a>
            </li>
        </ul>
...
<div class = "container">
    <div class = "row">
        <div class = "col text-center">
            <form method = "post" action ="noticeadmin.php">
                <div class = "form-group">
                    <label><strong>Notice Title</strong></label>
                    <textarea class="form-control rounded-0" id="notice" name = "notice" rows="10"></textarea>
                    <button class = "btn btn-success mt-3">ADD Notice</button>
                </div>
            </form>
        </div>
    </div>
